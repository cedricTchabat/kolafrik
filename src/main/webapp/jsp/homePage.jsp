...
<html>
   ...
   <div class="container" >
    <div class="header" style="background-color: black;">
	  ...
	  <img class="img-responsive" src="images/logo.jpeg" style="padding : 5px 5px 5px 5px; height:60px;">
	</div>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel"  >
	   ...
	   <ol class="carousel-indicators">
	    ...
	    <div class="carousel-inner" role="listbox" >
		 ...
		 <div class="item" >
			    <img alt="Third slide" src="images/slide1.jpg" >
				<div class="container">
				<div class="carousel-caption">
				     <h1> Example headline</h1>
					 <p>test</p>
...
<div class="row" >
<div class="col-md-4">
<img class="img-circle" style="width: 90px; height: 90px;" alt="Generic placeholder image" src="images/settings.jpeg">
<h2>Articles</h2>
